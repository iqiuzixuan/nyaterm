...
pub type DirectTransportConnector = Arc<dyn Fn(Destination) -> DirectTransportFuture + Send + Sync>;
...
pub struct Config {
    ...
    pub(crate) server_certificate_verifier: Option<Arc<dyn ServerCertificateVerifier>>,
...
pub struct ConfigBuilder {
    ...
    server_certificate_verifier: Option<Arc<dyn ServerCertificateVerifier>>,
...
impl ConfigBuilder {
    ...
    pub fn with_server_certificate_verifier(
        ...
        self.server_certificate_verifier = Some(verifier);
        self
    }
    ...
    pub fn build(mut self) -> anyhow::Result<Config> {
        ...
        Ok(Config {
            ...
            server_certificate_verifier: self.server_certificate_verifier,
